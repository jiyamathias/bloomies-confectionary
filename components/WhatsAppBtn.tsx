...
export function WhatsAppBtn({ href, children, className = '', block = false }: Props) {
  return (
    <Link
      href={href}
      target="_blank"
      ...
      className={`inline-flex items-center justify-center gap-2.5 bg-[#25D366] text-white
        ...
        hover:bg-[#1BBE5C] hover:-translate-y-0.5 hover:shadow-[0_12px_32px_rgba(37,211,102,0.35)]
        active:scale-[0.97]
        ${block ? 'w-full' : ''}
        ${className}`}
    >
