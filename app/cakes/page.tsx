...
export default function CakesPage() {
  ...
  return (
    <>
      ...
      {/* How it works */}
      <div className="bg-[#F0EBFF] border-b border-[rgba(232,96,154,0.12)]">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-6">
          ...
          {['1. Pick your cake', '2. Customise it', '3. Add extras', '4. Order via WhatsApp'].map((step, i) => (
            <div key={i} className="flex items-center gap-3 justify-center sm:justify-start">
              <span className="w-7 h-7 rounded-full bg-[#E8609A] text-white text-[0.72rem] font-bold flex items-center justify-center shrink-0">
                {i + 1}
              </span>
              <span className="text-[0.82rem] text-[#7B5EA7] font-medium">{step.slice(3)}</span>
              {i < 3 && <span className="hidden sm:block text-[#C5B0E8] text-lg">›</span>}
            </div>
          ))}
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-10 lg:py-14 space-y-16">

        {/* ── ONE LAYER CAKES ── */}
        <section>
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-8 pb-5 border-b border-[rgba(232,96,154,0.12)]">
            <div>
              ...
              <h2 className="font-cormorant text-[2rem] text-[#5B2D8E] font-normal">
                One Layer Cakes
              </h2>
              <p className="text-[0.85rem] text-[#7B5EA7] mt-1 max-w-lg">
        ...
        <section>
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-8 pb-5 border-b border-[rgba(232,96,154,0.12)]">
            <div>
              <div className="inline-flex items-center gap-1.5 bg-[rgba(232,96,154,0.1)] border border-[rgba(232,96,154,0.25)] text-[#E8609A] px-3 py-1 rounded-full text-[0.7rem] font-medium mb-2">
                ✨ Fully Customisable
              </div>
              <h2 className="font-cormorant text-[2rem] text-[#5B2D8E] font-normal">
                Custom Design Cakes
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 pb-14">
        <div className="bg-[#5B2D8E] rounded-2xl p-8 sm:p-12 flex flex-col sm:flex-row
          ...
          <div className="absolute -top-12 -right-12 w-48 h-48 rounded-full bg-[#E8609A]/10 pointer-events-none" />
          <div className="relative z-[1]">
            <h3 className="font-cormorant text-[1.8rem] text-white font-normal mb-1">
              Have something truly unique in mind?{' '}
              <em className="italic text-[#E8DAFF]">Let's bring it to life.</em>
            </h3>
